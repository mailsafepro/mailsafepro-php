...
$apiInstance = new MailSafePro\Api\DeveloperToolsApi(
...
try {
    ...
    echo 'Exception when calling DeveloperToolsApi->clearRequestLogsLogsLogsRequestsDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DeveloperToolsApi->getRequestLogsLogsLogsRequestsGet: ', $e->getMessage(), PHP_EOL;
}
```
