...
/**
 * DNSRecordDKIM Class Doc Comment
 *
 * @category Class
 ...
 */
class DNSRecordDKIM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DNSRecordDKIM';
    ...
    */
    ...
    public function setKeyLength($key_length)
    {
        if (is_null($key_length)) {
            array_push($this->openAPINullablesSetToNull, 'key_length');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('key_length', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
