    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if (!is_null($url) && (mb_strlen($url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookUpdate., must be smaller than or equal to 2083.');
        }
        if (!is_null($url) && (mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookUpdate., must be bigger than or equal to 1.');
        }
