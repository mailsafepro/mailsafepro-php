...
/**
 * RegisterEndpoint Class Doc Comment
 *
 * @category Class
 * @package  MailSafePro
 * @author   OpenAPI Generator team
 ...
 */
class RegisterEndpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterEndpoint';
    ...
    */
    ...
    public function setCallbackUrl($callback_url)
    {
        ...
        if ((mb_strlen($callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling RegisterEndpoint., must be bigger than or equal to 1.');
        }
