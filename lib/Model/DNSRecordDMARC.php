...
/**
 * DNSRecordDMARC Class Doc Comment
 *
 * @category Class
 ...
 */
class DNSRecordDMARC implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DNSRecordDMARC';
    ...
    */
    ...
    {
        if (is_null($pct)) {
            array_push($this->openAPINullablesSetToNull, 'pct');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pct', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
